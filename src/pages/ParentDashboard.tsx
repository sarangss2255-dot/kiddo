...
import { StyleSheet, View, Text, TouchableOpacity, SafeAreaView, TextInput, Modal, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
import { useAuth } from '../AuthContext';
import { Plus, Users, CheckCircle2, XCircle, LayoutDashboard, LogOut, Star, Pencil, Smartphone, Download } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.sidebar}>
        ...
        >
          <Smartphone color="#64748b" size={24} />
          <Text style={styles.sidebarIconText}>App</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  sidebarIconBtn: { alignItems: 'center', marginBottom: 24, padding: 10, borderRadius: 12, backgroundColor: '#f8fafc' },
  sidebarIconText: { fontSize: 9, fontWeight: '800', color: '#64748b', textTransform: 'uppercase', marginTop: 4 },
